...
import { Search, Navigation, MapPin, Clock, Route, X, Loader2 } from 'lucide-react';
  ...
  useEffect(() => {
    const initMap = async () => {
      ...
      try {
        ...
        const sessionTokenInstance = new google.maps.places.AutocompleteSessionToken();
    ...
    <div className="w-full max-w-7xl mx-auto p-4">
      <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-6 text-white">
          ...
          <p className="text-blue-100">Find the best route to your destination</p>
        </div>
          ...
          {routeInfo && (
            <div className="mt-6 bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
              ...
              <div className="space-y-2 text-sm text-gray-600">
                ...
                <div><strong>To:</strong> {routeInfo.endAddress}</div>
              </div>
            </div>
          )}
        </div>
